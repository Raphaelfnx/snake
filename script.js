...
const nPlay = document.querySelector(".nplay-board")

function easy(){
    playBoard.style.gridTemplate = 'repeat(30, 1fr) / repeat(30, 1fr)'
    btnE.style.borderRadius = '80%'

} 

function hard(){
    playBoard.style.gridTemplate = 'none'
    btnH.style.borderRadius = '80%'    
}
